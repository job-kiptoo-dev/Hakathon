...
export const JobSearchPage: React.FC = () => {
  ...
  }, [jobs, searchTerm, location, jobType, remote, salaryRange]);
  ...
  return (
    <>
      {/* DEBUG: Remove this after fixing blank page */}
      <div style={{ background: '#fee', color: '#900', padding: '8px', marginBottom: '8px', fontSize: '14px' }}>
        <strong>DEBUG:</strong> User: {user ? user.email : 'No user'} | Jobs loaded: {jobs.length} | Filtered: {filteredJobs.length}
      </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <Select value={remote} onValueChange={setRemote}>
                    <SelectTrigger>
                      <SelectValue placeholder="All styles">All styles</SelectValue>
                    </SelectTrigger>
                    <SelectContent>
